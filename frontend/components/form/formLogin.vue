...
<template>
  <form @submit.prevent="handleSubmit" class="login-form">
    <div class="login-form__group">
      ...
      >
        <template #icon>
          <Icon name="fluent:mail-24-regular" class="login-form__icon" />
        </template>
      </UiBaseInput>
    </div>
    ...
    <div class="login-form__group">
      <div class="login-form__checkbox-container">
        ...
        <label for="remember" class="login-form__checkbox-label">{{ t('rememberMe') }}</label>
      </div>
    ...
    <button type="submit" class="login-form__submit-button gradient-button">
      {{ t('login') }}
    </button>
  </form>
